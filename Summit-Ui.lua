...
function summitLib:CreateWindow(ConfigArgs)
    ...
    TabsScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, UIListLayout.AbsoluteContentSize.Y)
end)
    ...
    TabContentsFrame.CanvasSize = UDim2.new(0, 0, 0, UIListLayout_2.AbsoluteContentSize.Y)
end)

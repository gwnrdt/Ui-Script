...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = Color3.fromRGB(115, 8, 18)
    UiWindow.BorderColor3 = Color3.fromRGB(115, 8, 18)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(155, 17, 30)
    Header.BorderColor3 = Color3.fromRGB(155, 17, 30)
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(155, 17, 30)
    Minimise.BorderColor3 = Color3.fromRGB(155, 17, 30)
...
Window.BackgroundTransparency = 0.1   -- <--- ADICIONADO: ajusta a transparência aqui

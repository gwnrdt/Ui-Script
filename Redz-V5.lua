...
local redzlib = {
    ...
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),     -- Preto (início)
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 255)),   -- Azul (meio)
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 255))    -- Azul (final)
}),
